...
if( ! class_exists('PMTI_Updater') ) {
    ...
    class PMTI_Updater {
        ...
        public function init() {
            ...
            add_filter( 'pre_set_site_transient_update_plugins', [$this, 'check_update'], 21 );
        ...
        public function plugin_row_meta( $links, $file ) {
            if ( $file == $this->name ) {
                $row_meta = [
                    'changelog'    => '<a href="' . admin_url( 'plugin-install.php?tab=plugin-information&plugin=wpai-toolset-types-add-on&section=changelog&TB_iframe=true&width=600&height=800' ) . '" class="thickbox open-plugin-details-modal" title="' . esc_attr( __( 'View WP All Import - Toolset Types Add-On Pro Changelog', PMTI_Plugin::TEXT_DOMAIN ) ) . '">' . __( 'Changelog', PMTI_Plugin::TEXT_DOMAIN ) . '</a>',
                ];
