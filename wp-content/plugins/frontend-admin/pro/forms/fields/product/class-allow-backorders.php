...
if ( ! class_exists( 'allow_backorders' ) ) :

	class allow_backorders extends Field_Base {
		...
		function initialize() {
			...
			$this->label    = __( 'Allow Backorders', 'acf-frontend-form-element' );
			...
			add_filter( 'acf/load_field/type=select', array( $this, 'load_allow_backorders_field' ), 2 );
