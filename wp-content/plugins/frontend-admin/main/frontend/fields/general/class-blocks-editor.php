...
if ( ! class_exists( 'blocks_editor' ) ) :
	...
	class blocks_editor extends Field_Base {
		...
		*/
		...
		function initialize() {
			...
			add_action( 'frontend_admin/form_assets/type=blocks_editor', array( $this, 'form_assets' ), 10, 2 );
			add_action( 'frontend_admin/form_assets/type=post_content', array( $this, 'form_assets' ), 10, 2 );
			add_action( 'frontend_admin/form_assets/type=product_description', array( $this, 'form_assets' ), 10, 2 );
	...
	/*
		...
		*/
		...
		function form_assets( $field, $form = array() ) {
